            ...
            <div class="card p-1 py-2" >
                ...
                <div class="card p-1 py-2">
                    <form method="POST" action="/stagiaires/{{$stagiaire->id}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-0">
                            <div class="d-flex flex-column"> <span class="text-left"> Saisi par: </span> <span class="text-left">{{$stagiaire->created_by}}</span> <span class="text-left"> : {{$stagiaire->created_at}}</span> </div>
                            <div class="d-flex flex-column"> <span class="text-left"> Modifié par: </span> <span class="text-left">{{$stagiaire->edited_by}}</span> <span class="text-left"> : {{$stagiaire->updated_at}}</span> </div>
                            <div >
