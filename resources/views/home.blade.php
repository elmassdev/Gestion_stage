 ...
 <div id="home">
  ...
  <div class="menu">
    @if(auth()->check() && auth()->user()->hasRole('manager'))
        <div class="bienvenue">
            <h3>  {{ Auth::user()->titre }} {{ Auth::user()->prenom }} {{ Auth::user()->nom }}, Bienvenue dans votre espace pour consulter les indicateurs des stages. </h3>
        </div>
        @endif
    ...
    <div class="container">
        ...
        <div class="square">
            <div class="info">
                <a class="btn col-md-12  " href="/stagiaires/{{$lastId}}"> Rechercher</a>
              </div>
              <div class="image">
                <a class="btn col-md-12  " href="/stagiaires/{{$lastId}}">
