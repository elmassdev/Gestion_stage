...
Route::get('/villes', [App\Http\Controllers\VilleController::class, 'index'])->name('villes')->middleware('auth'); 
Route::post('/villes', [App\Http\Controllers\VilleController::class, 'store'])->name('villes')->middleware('auth');
Route::get('/villes', [App\Http\Controllers\VilleController::class, 'search'])->name('villes')->middleware('auth'); 
