 ...
 <div id="home">
  ...
  <div class="menu">
    <?php if(auth()->check() && auth()->user()->hasRole('manager')): ?>
        <div class="bienvenue">
            <h3>  <?php echo e(Auth::user()->titre); ?> <?php echo e(Auth::user()->prenom); ?> <?php echo e(Auth::user()->nom); ?>, Bienvenue dans votre espace pour consulter les indicateurs des stages. </h3>
        </div>
        <?php endif; ?>
    ...
    <div class="all">
        ...
        <div class="square">
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/stagiaires/create">
        ...
        <div class="square">
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/indicators/index">
        ...
        <div class="square">
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/stagiaires">
        ...
        <div class="square">
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/export">
        ...
        <div class="square">
            <div class="info">
                <a class="btn col-md-12  " href="/stagiaires/<?php echo e($lastId); ?>"> Rechercher</a>
              </div>
              <div class="image">
                <a class="btn col-md-12  " href="/stagiaires/<?php echo e($lastId); ?>">
            ...
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/encadrants/1">
        ...
        <div class="square">
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/indicators/graph">
        ...
        <div class="square">
            <div class="info">
              ...
              <div class="image">
                <a class="btn col-md-12" href="/user/assign-roles">
        ...
        <div class="square">
            ...
            <div class="image">
                <a class="btn col-md-12" href="/surete">
