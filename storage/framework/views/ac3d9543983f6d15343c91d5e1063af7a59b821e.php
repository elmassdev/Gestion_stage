...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="prenom" class="col-md-4 col-form-label text-md-left"><?php echo e(__('Prénom')); ?></label>
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="nom" class="col-md-4 col-form-label text-md-left"><?php echo e(__('Nom')); ?></label>
                            <div class="col-md-6">
