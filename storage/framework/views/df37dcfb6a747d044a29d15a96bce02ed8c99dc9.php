        ...
        <div class="card col-md-8">
            ...
            <table >
                <tr>
                    ...
                    <a href="/villes" target="/blank" class=" col-md-8 mx-auto my-2 btn btn-primary">Liste des villes</a>
                </tr>
            </table>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Share\main\Gestion_stage\resources\views/villes/create.blade.php ENDPATH**/ ?>