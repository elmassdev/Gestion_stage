            ...
            <div class="card p-1">
                <div class="row ">
                    <div class="row ">
                            <div class="col-md-8  position my-auto top-0 end-0">
                                ...
                                <div class="allergy"><b><?php echo e($encadrant->service); ?></b></div>
                ...
                <div class="card p-1">
                    <table>
                        <tbody>
                            <tr>
                                <td> <a href="<?php echo e(URL::to( 'encadrants/' . $previous )); ?>" class="btn btn-success text-light"> Precedant </a></td>
                                <td><a href="<?php echo e(URL::to( 'encadrants/' . $next )); ?>" class="btn btn-success text-light"> Suivant</a></td>
                                <td><a href="/encadrants/" class="btn btn-primary text-light"> Liste encadrants</a></td>
                                <td><a href="/encadrants/<?php echo e($encadrant->id); ?>/modification"  class="btn btn-warning text-dark">Modifier</a></td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/encadrants/<?php echo e($result->id); ?>"><?php echo e($result->service); ?></a></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Github\Gestion_stage\resources\views/encadrants/show.blade.php ENDPATH**/ ?>