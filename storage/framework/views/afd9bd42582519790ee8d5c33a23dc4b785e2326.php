...
unset($__errorArgs, $__bag); ?>" name="etablissement" required autocomplete="etablissement" required>
...
unset($__errorArgs, $__bag); ?>" name="ville" autocomplete="ville" required>
...
unset($__errorArgs, $__bag); ?>" name="type_stage"  autocomplete="type_stage" required>
                        <option  selected disabled></option>
...
unset($__errorArgs, $__bag); ?>" name="type_formation"  autocomplete="type_formation" required>
                        <option  selected disabled>  </option>
...
unset($__errorArgs, $__bag); ?>" name="encadrant" required autocomplete="encadrant" required>
                    <option selected disabled></option>
...
unset($__errorArgs, $__bag); ?>" name="service" required autocomplete="service" required>
