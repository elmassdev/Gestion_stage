...
<div class="container">
    ...
    <div class="row card">
        <div class="card-header">
            <div class="card-body">
                <form method="GET" action="/indicators" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Share\27-11\Gestion_stage\resources\views/indicators.blade.php ENDPATH**/ ?>