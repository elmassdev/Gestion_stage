                ...
                <div class="card-body">
                    <form method="POST" action="/encadrants/<?php echo e($encadrant->id); ?>/modification" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <select id="titre" type="text" class="form-control <?php $__errorArgs = ['titre'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="prenom" type="text" value="<?php echo e($encadrant->prenom); ?>" class="form-control <?php $__errorArgs = ['prenom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="nom" value="<?php echo e($encadrant->nom); ?>" oninput="this.value = this.value.charAt(0).toUpperCase()+ this.value.slice(1)" required autocomplete="nom"  autofocus>
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e($encadrant->phone); ?>"  autocomplete="phone" placeholder="ex: +212662077439" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e($encadrant->email); ?>"  autocomplete="email">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Share\main\Gestion_stage\resources\views/encadrants/modification.blade.php ENDPATH**/ ?>