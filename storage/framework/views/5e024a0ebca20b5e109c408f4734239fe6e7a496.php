...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-0">
                            <div class="d-flex flex-column"> <span class="text-left"> Saisi par: </span> <span class="text-left"><?php echo e($stagiaire->created_by); ?></span> </div>
                            <div class="d-flex flex-column"> <span class="text-left"> Modifié par: </span> <span class="text-left"><?php echo e($stagiaire->edited_by); ?></span> </div>
                            <div >
