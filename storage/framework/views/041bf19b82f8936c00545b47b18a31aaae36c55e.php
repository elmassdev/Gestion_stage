...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 border">
            <h4> <u>Nombre des stagiaires en cours par encadrants </u></h4>
            <table class="table table-striped table-responsive">
                <thead>
                    <tr class="small">
                        <th>Encadrant</th>
        ...
        <div class="card-header">
            <div class="card">
                <form method="GET" action="/indicators/index" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <h4 class="col-md-5"><u>Liste des stagiaires pour une date:</u></h4>
                        <div class="col-md-3">
                            ...
                            <div class="card-header">
                                <div class="card-body">
                                    <form method="GET" action="/indicators/index" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <h4 class="col-md-5"><u>Liste des stagiaires pour aujourd'hui:</u></h4>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Share\27-11\Gestion_stage\resources\views/indicators/index.blade.php ENDPATH**/ ?>